...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://aria_user:aria_password@localhost:5432/aria_dev"
    ...
    # Security
    SECRET_KEY: str = "dev-secret-key-change-in-production-make-it-long-and-random"
    ALGORITHM: str = "HS256"
